...
import styles from './WordToTXT.module.css';

const WordToTXT: React.FC = () => {
  ...
  const convertToTXT = async () => {
    ...
    try {
      ...
      setDownloadUrl(url);
      setDownloadName(`${file.name.replace('.docx', '')}.txt`);
      setStep(3);
    } catch (err) {
      console.error(err);
      setError('Failed to extract text. Make sure it is a valid .docx file.');
    } finally {
      setProcessing(false);
    }
  };
          ...
          <div className={styles.stepContainer}>
            <label className={styles.dropZone}>
              ...
              <div className={styles.uploadPrompt}>
                ...
                <span>Extracts text from Microsoft Word Documents</span>
              </div>
            </label>
            {error && (
          ...
          <div className={styles.stepContainer}>
            ...
            <div className={styles.actions}>
              ...
              >
                ...
                {processing ? 'Extracting text...' : 'Extract Text (.txt)'}
              </button>
        ...
        {step === 3 && downloadUrl && (
          <div className={styles.stepContainer}>
            <div className={styles.successCard}>
              ...
              <p>Your plain text file is ready for download.</p>
            </div>
