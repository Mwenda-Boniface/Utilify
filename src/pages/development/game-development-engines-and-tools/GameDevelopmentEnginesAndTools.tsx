...
import styles from './GameDevelopmentEnginesAndTools.module.css';
import { GAMEDEVELOPMENTENGINESANDTOOLS_ITEMS } from './gameDevelopmentEnginesAndToolsData.ts';

interface Props { searchValue?: string; }

const GameDevelopmentEnginesAndToolsCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = GAMEDEVELOPMENTENGINESANDTOOLS_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Game Development Engines and Tools</h2>
        </div>
      </header>
...
export default GameDevelopmentEnginesAndToolsCategory;
