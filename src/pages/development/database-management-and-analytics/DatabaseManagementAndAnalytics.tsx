...
import styles from './DatabaseManagementAndAnalytics.module.css';
import { DATABASEMANAGEMENTANDANALYTICS_ITEMS } from './databaseManagementAndAnalyticsData.ts';

interface Props { searchValue?: string; }

const DatabaseManagementAndAnalyticsCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = DATABASEMANAGEMENTANDANALYTICS_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Database Management and Analytics</h2>
        </div>
      </header>
...
export default DatabaseManagementAndAnalyticsCategory;
