...
import styles from './DocumentationCodeSearchAndLearning.module.css';
import { DOCUMENTATIONCODESEARCHANDLEARNING_ITEMS } from './documentationCodeSearchAndLearningData.ts';

interface Props { searchValue?: string; }

const DocumentationCodeSearchAndLearningCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = DOCUMENTATIONCODESEARCHANDLEARNING_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Documentation, Code Search, and Learning</h2>
        </div>
      </header>
...
export default DocumentationCodeSearchAndLearningCategory;
