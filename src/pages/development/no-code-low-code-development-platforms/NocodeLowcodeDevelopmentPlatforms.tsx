...
import styles from './NocodeLowcodeDevelopmentPlatforms.module.css';
import { NOCODELOWCODEDEVELOPMENTPLATFORMS_ITEMS } from './noCodeLowCodeDevelopmentPlatformsData.ts';

interface Props { searchValue?: string; }

const NocodeLowcodeDevelopmentPlatformsCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = NOCODELOWCODEDEVELOPMENTPLATFORMS_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>No-Code / Low-Code Development Platforms</h2>
        </div>
      </header>
...
export default NocodeLowcodeDevelopmentPlatformsCategory;
