...
import styles from './ContinuousIntegrationContinuousDeploymentCicd.module.css';
import { CONTINUOUSINTEGRATIONCONTINUOUSDEPLOYMENTCICD_ITEMS } from './continuousIntegrationContinuousDeploymentCICDData.ts';

interface Props { searchValue?: string; }

const ContinuousIntegrationContinuousDeploymentCicdCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = CONTINUOUSINTEGRATIONCONTINUOUSDEPLOYMENTCICD_ITEMS.filter(item =>
...
export default ContinuousIntegrationContinuousDeploymentCicdCategory;
