...
import styles from './MonitoringObservabilityAndLogging.module.css';
import { MONITORINGOBSERVABILITYANDLOGGING_ITEMS } from './monitoringObservabilityAndLoggingData.ts';

interface Props { searchValue?: string; }

const MonitoringObservabilityAndLoggingCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = MONITORINGOBSERVABILITYANDLOGGING_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Monitoring, Observability, and Logging</h2>
        </div>
      </header>
...
export default MonitoringObservabilityAndLoggingCategory;
