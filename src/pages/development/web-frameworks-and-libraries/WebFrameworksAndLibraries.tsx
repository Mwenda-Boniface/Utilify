...
import styles from './WebFrameworksAndLibraries.module.css';
import { WEBFRAMEWORKSANDLIBRARIES_ITEMS } from './webFrameworksAndLibrariesData.ts';

interface Props { searchValue?: string; }

const WebFrameworksAndLibrariesCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = WEBFRAMEWORKSANDLIBRARIES_ITEMS.filter(item =>
...
export default WebFrameworksAndLibrariesCategory;
