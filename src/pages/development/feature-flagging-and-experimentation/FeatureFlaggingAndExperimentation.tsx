...
import styles from './FeatureFlaggingAndExperimentation.module.css';
import { FEATUREFLAGGINGANDEXPERIMENTATION_ITEMS } from './featureFlaggingAndExperimentationData.ts';

interface Props { searchValue?: string; }

const FeatureFlaggingAndExperimentationCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = FEATUREFLAGGINGANDEXPERIMENTATION_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Feature Flagging and Experimentation</h2>
        </div>
      </header>
...
export default FeatureFlaggingAndExperimentationCategory;
