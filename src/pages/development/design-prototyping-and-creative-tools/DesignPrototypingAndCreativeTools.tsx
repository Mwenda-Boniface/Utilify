...
import styles from './DesignPrototypingAndCreativeTools.module.css';
import { DESIGNPROTOTYPINGANDCREATIVETOOLS_ITEMS } from './designPrototypingAndCreativeToolsData.ts';

interface Props { searchValue?: string; }

const DesignPrototypingAndCreativeToolsCategory: React.FC<Props> = ({ searchValue = '' }) => {
  const filteredItems = DESIGNPROTOTYPINGANDCREATIVETOOLS_ITEMS.filter(item =>
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.titleRow}>
          ...
          <h2>Design, Prototyping, and Creative Tools</h2>
        </div>
      </header>
...
export default DesignPrototypingAndCreativeToolsCategory;
