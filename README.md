<div align="center">
  ...
  <img src="src/assets/images/UTILIFY.png" alt="Utilify - Free Online Utility Tools" width="96" />

  # Utilify — Free Online Utility Tools

  ### *60+ Browser-Based Tools for Developers, Designers & Everyday Tasks*

  [![Live Demo](https://img.shields.io/badge/Live%20Demo-utilifytools.dpdns.org-22c55e?style=for-the-badge&logo=vercel)](https://www.utilifytools.dpdns.org)
  [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://opensource.org/licenses/MIT)
  [![Privacy](https://img.shields.io/badge/Privacy-100%25%20Client--Side-blue?style=for-the-badge)](#️-privacy-first-no-server-uploads)
...
```mermaid
graph TD
    UI["React 19 + Framer Motion"] --> State["Local State & localStorage"]
    UI --> Workers["WebAssembly / Web Workers"]
    Workers --> PDF["pdf-lib & Mammoth (Documents)"]
    Workers --> Tess["Tesseract.js (OCR)"]
    Workers --> JSZip["JSZip (Compression)"]
    Workers --> XLSX["xlsx (Spreadsheets)"]
    UI --> Blobs["Local Browser Blob URLs (Output)"]
```
